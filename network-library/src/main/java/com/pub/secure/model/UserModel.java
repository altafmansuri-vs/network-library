...
public class UserModel {
    ...
    public String id, name,number,email,address,whatsapp,facebook,instagram, profile_pic,balance,designation, category_id, state, district, refer_id, refered, subscription_name, subscription_price, subscription_date, subscription_end_date,login, active_at, social, social_id, auth_token, device_token, status, updated_at, created_at;
    public int posts_limit=0,business_limit=0,political_limit=0,daily_limit;
    public int festival,business,political,video,automation,website,animated_video;
